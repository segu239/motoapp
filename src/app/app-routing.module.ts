...
children:[
   { path: 'puntoventa', component: PuntoventaComponent, data :{titulo:'Punto de Venta'} },
    ...
    { path: 'newcajalista', component: NewCajaListaComponent, canActivate: [AuthGuard], data: { titulo: "Nuevo Cajalista", roles: [UserRole.SUPER, UserRole.ADMIN] } },
    { path: 'editcajalista', component: EditCajaListaComponent, canActivate: [AuthGuard], data: { titulo: "Editar Cajalista", roles: [UserRole.SUPER, UserRole.ADMIN] } },
    {path: 'cajaconcepto', component: CajaconceptoComponent, data: { titulo: "Cajaconcepto" } },
    { path: 'newcajaconcepto', component: NewcajaconceptoComponent, canActivate: [AuthGuard], data: { titulo: "Nuevo Cajaconcepto", roles: [UserRole.SUPER, UserRole.ADMIN] } },
    { path: 'editcajaconcepto', component: EditcajaconceptoComponent, canActivate: [AuthGuard], data: { titulo: "Editar Cajaconcepto", roles: [UserRole.SUPER, UserRole.ADMIN] } },
