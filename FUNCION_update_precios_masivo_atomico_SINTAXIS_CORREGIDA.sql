-- =====================================================
-- FUNCIÓN MEJORA PRECISIÓN: update_precios_masivo_atomico
-- FECHA: 19 de Agosto de 2025
-- CORRECCIÓN CRÍTICA: Eliminación de redondeos prematuros para máxima precisión
-- PROBLEMA RESUELTO: Pérdida de precisión decimal por redondeos innecesarios
...
BEGIN
    ...
    LOOP
        ...
        -- ✅ MEJORA PRECISIÓN: Eliminados redondeos prematuros para usar los 4 decimales disponibles en BD
        ...
        -- ✅ MEJORA PRECISIÓN: Eliminado redondeo prematuro en prefi1
        ...
        -- ✅ MEJORA PRECISIÓN: Eliminado redondeo prematuro en prefi2
        UPDATE artsucursal a SET 
            prefi2 = CASE 
        ...
        -- ✅ MEJORA PRECISIÓN: Eliminado redondeo prematuro en prefi3
        UPDATE artsucursal a SET 
            prefi3 = CASE 
        ...
        -- ✅ MEJORA PRECISIÓN: Eliminado redondeo prematuro en prefi4
        UPDATE artsucursal a SET 
            prefi4 = CASE 
...
--    - ✅ MEJORA: Sin redondeo prematuro para máxima precisión (4 decimales)
-- 
