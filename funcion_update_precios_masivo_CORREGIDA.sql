-- ===================================================================
-- FUNCIÓN CORREGIDA: update_precios_masivo
-- ===================================================================
-- Fecha: 13 de Agosto de 2025
-- Problema: Los campos precio_costo y precio_venta se registran como 0 en lugar del valor correcto
-- Solución: Extraer el tipo real de la descripción antes de evaluar los flags
...
BEGIN
    ...
    FOR rec IN 
        ...
        AND (p_cd_proveedor IS NULL OR cd_proveedor = p_cd_proveedor)
...
-- ===================================================================
-- 1. ✅ VARIABLE v_tipo_real: Extrae el tipo real ('costo' o 'final') de la descripción
-- 2. ✅ LÓGICA CORREGIDA: Los flags precio_costo/precio_venta usan v_tipo_real
-- 3. ✅ COMPATIBILIDAD: Mantiene la descripción completa en el campo 'tipo'
-- 4. ✅ AUDITORÍA MEJORADA: Incluye id_articulo en dactualiza para mejor trazabilidad
-- 5. ✅ SINTAXIS CORRECTA: Compatible con PostgreSQL 9.4 (comillas simples + escape)
-- 6. ✅ SIN CAMBIOS: No modifica la lógica de cálculo de precios (ya funcionaba)
-- ===================================================================