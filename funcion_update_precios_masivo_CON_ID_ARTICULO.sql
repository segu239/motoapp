-- =====================================================================
-- FUNCIÓN UPDATE PRECIOS MASIVO - VERSIÓN ADAPTADA CON CAMPO id_articulo
-- BASADA EN: funcion_update_precios_masivo_FINAL.sql (FUNCIONANDO AL 100%)
-- CAMBIO: Agregado campo id_articulo en INSERT a tabla dactualiza
-- FECHA: 12 de Agosto de 2025 - ADAPTACIÓN PARA NUEVO CAMPO
-- =====================================================================
    ...
    LOOP
        ...
        BEGIN
            INSERT INTO dactualiza (
                ...
                fecha,
                id_articulo  -- ✅ NUEVO CAMPO AGREGADO
            ) VALUES (
                COALESCE(v_id_act, 0),
...
-- =====================================================================
-- FUNCIÓN AUXILIAR: Verificar estado de actualización (SIN CAMBIOS)
-- =====================================================================
...
-- =====================================================================
-- ✅ AGREGADO: Campo id_articulo en INSERT a tabla dactualiza (línea 162 y 184)
-- ✅ FUENTE DE DATOS: rec.id_articulo (ya disponible en cursor, línea 117)
-- ✅ POSICIONAMIENTO: Campo agregado al final para mantener compatibilidad
-- ✅ VALIDACIÓN NULL: COALESCE(rec.id_articulo, 0) para seguridad
-- ✅ SINTAXIS PROBADA: Basado en función funcionando al 100% en producción
-- ✅ ROLLBACK AUTOMÁTICO: Mantenida funcionalidad ACID completa
-- ✅ AUDITORÍA MEJORADA: Ahora incluye trazabilidad por id_articulo único

-- =====================================================================
-- BENEFICIOS DEL NUEVO CAMPO id_articulo:
-- =====================================================================
-- 🔍 TRAZABILIDAD MEJORADA: Identificación única de cada artículo modificado
-- 🔍 AUDITORÍA ROBUSTA: Relación directa con tabla artsucursal por clave primaria
-- 🔍 CONSULTAS OPTIMIZADAS: JOIN directo sin depender de cd_articulo (que puede repetirse)
-- 🔍 COMPATIBILIDAD: Campo agregado sin afectar funcionalidad existente
-- 🔍 INTEGRIDAD: Referencia directa a la clave primaria de artsucursal

-- =====================================================================
-- INSTRUCCIONES DE APLICACIÓN:
-- =====================================================================
-- 1. EJECUTAR: Esta función para reemplazar la versión anterior
-- 2. PROBAR: Con datos de test para verificar que id_articulo se graba
-- 3. VALIDAR: Que los registros en dactualiza incluyan el nuevo campo
-- 4. VERIFICAR: Que la funcionalidad existente no se vea afectada
-- =====================================================================